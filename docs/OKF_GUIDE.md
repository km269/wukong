...
> **版本**: v0.3.3（OKF 规范版本 0.1） | **最后更新**: 2026-08-30 | **源码**: `internal/okf/` · `internal/knowledge/okf.go` · `internal/cortex/okf_*.go` · `internal/skill/` · `internal/evolution/okf.go` · `internal/ard/okf.go`
