...
// TestSmokeRealChrome launches a real headless Chrome via the chromedp
// pool and renders a local page — verifies the browser environment
// works on this machine (precondition for P2-1 phase 2).
...
<body><a href="/page2">link</a><p>hello smoke</p></body></html>`))
	...
	// drain the pool and release Chrome automatically; defer Close is
